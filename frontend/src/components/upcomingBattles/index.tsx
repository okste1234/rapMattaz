                ...
                <div className='w-full grid lg:grid-cols-4 md:grid-cols-2 gap-6'>
                    {
                        artistes.map((art, index) => (
                            <div className='bg-[#FFFFFF]/[5%] p-4 rounded-lg border border-[#FFFFFF]/[10%] backdrop-blur-lg flex flex-col items-center gap-2' key={index}>
                                ...
                                <h3 className="text-gray-100 text-center font-Bebas">{art.name}</h3>
                                <span className='border font-Bebas border-[#FFFFFF]/[10%] px-3 py-1.5 rounded-md text-[#D6D1FA]'>{art.points} -
                                    {" "}<span className='text-[#897AF0]'>Ra points</span>
                                </span>
                                <button className="border mt-4 rounded-lg border-[#FFFFFF]/[10%] w-full py-2 text-gray-100 font-Bebas">Follow</button>
                            </div>
                        ))
                    }
                </div>
